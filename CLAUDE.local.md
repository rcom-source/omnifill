...
**YOU ARE IN: `omnifill_first_mile/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/omnifill_first_mile/` (rig root) or other directories
...
**Your mail address:** `omnifill_first_mile/polecats/rust`
**Your rig:** omnifill_first_mile
**Your Witness:** `omnifill_first_mile/witness`
...
| Ask Witness for help | `gt mail send omnifill_first_mile/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`omnifill_first_mile/witness`) when:
...
```bash
gt mail send omnifill_first_mile/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
